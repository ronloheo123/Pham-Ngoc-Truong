<footer id="footer" class="module footer w-full relative font-poppins">
    <div class="tong">
      <div class="bg-cover h-300 w-full relative" style="background-image: url(<?php echo e($data->module['image1']->url); ?>)">
